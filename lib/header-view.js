...
class DataAtomView {
  ...
  createView() {
    ...
    this.element.classList.add('results-header');
  ...
  addConnection(connectionName) {
    ...
    this.connectionList.setAttribute('disabled', false);
    this.disconnectBtn.setAttribute('disabled', false);
  }
  ...
  addDbNames(names) {
    ...
    if (names.length > 1) {
      this.databaseList.setAttribute('disabled', false);
      this.executeBtn.setAttribute('disabled', false);
    }
    else {
      this.databaseList.setAttribute('disabled', true);
      this.executeBtn.setAttribute('disabled', true);
  ...
  onQueryToggle() {
    this.useEditorAsQuery = !this.useEditorAsQuery;
