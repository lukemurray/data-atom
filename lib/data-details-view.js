...
class DataDetailsView {
  ...
  createView() {
    ...
    this.element.classList.add('data-details-panel');
    ...
    this.dbList.classList.add('db-list');
    this.element.appendChild(this.dbList);
  }
  ...
  toggleView() {
    if (this.isShowing) {
      ...
      else
      {
        ...
        atom.workspace.addLeftPanel({item:this.element});
      }
      this.isShowing = true;
    }
  }
