...
class DataAtomController {
  ...
  execute() {
    ...
    var query = editor.getSelectedText() ? editor.getSelectedText() : (/p?sql$/).test(editor.getTitle()) ? editor.getText() : this.mainView.isShowing ? this.mainView.headerView.getQuery() : '';
