...
class DataAtomController {
  ...
  showResultsView() {
    ...
    if (currentViewState.dataManager) {
      currentViewState.dataManager.getDatabaseNames(names => this.mainView.setState(currentViewState.dataManager.getConnectionName(), names, currentViewState.dataManager.activeDatabase, currentViewState.height, currentViewState.useEditorAsQuery));
    }
    else {
      this.mainView.setState('0', [], '', currentViewState.height, currentViewState.useEditorAsQuery);
    }
