...
export default class DataAtomView {
  constructor(useEditorQuery) {
    ...
    if (this.state.useEditorQuery)
      this.refs.queryToggle.className += 'btn-query-toggle-up';
    else
      this.refs.queryToggle.className += 'btn-query-toggle-down';
  ...
  render() {
    return (<header className='header toolbar'>
      ...
      <button className='btn btn-default btn-query-toggle' title='Toggle between executing content from the active editor or the query panel below' ref='queryToggle'></button>
  ...
  toggleQuerySource(useEditorQuery) {
    ...
    if (useEditorQuery) {
      this.refs.queryToggle.classList.remove('btn-query-toggle-down');
      this.refs.queryToggle.classList.add('btn-query-toggle-up');
    }
    else {
      this.refs.queryToggle.classList.remove('btn-query-toggle-up');
      this.refs.queryToggle.classList.add('btn-query-toggle-down');
    }
  }
